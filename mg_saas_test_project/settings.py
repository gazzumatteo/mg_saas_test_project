...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-JwQudOTdNsTrVOgHs8Wkx3nWxz9xSuNPtPk83RcG")
...
ROOT_URLCONF = "mg_saas_test_project.urls"
...
WSGI_APPLICATION = "mg_saas_test_project.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="mg_saas_test_project"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "mg_saas_test_project_language"
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="dev@duckma.com")
...
EMAIL_SUBJECT_PREFIX = "[Test Project] "
...
ASGI_APPLICATION = "mg_saas_test_project.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
WAGTAIL_SITE_NAME = "Test Project Content"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "mg_saas_test_project": {
            "handlers": ["console"],
            "level": env("MG_SAAS_TEST_PROJECT_LOG_LEVEL", default="INFO"),
        },
    },
}
